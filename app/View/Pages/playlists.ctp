			...
			<div class="large-12 columns title-bar">
				<div class="callout-i top-b wow pulse">
					<ul class="breadcrumbs">
					  ...
					  <li class="current"><a href="#">playlists</a></li>
					</ul>
				</div>
			</div>
			<?php
			...
			<div class="row padded-content">
				<div class="large-12 columns title-bar">
					<div class="callout-i top-b wow pulse">
						<ul class="breadcrumbs">
						  <li><?php echo $this->Html->link(__(('music'), true), array('controller'=> 'pages', 'action'=>'music'), array('escape' => false, 'class'=>'d-menu')); ?></li>
						  <li><?php echo $this->Html->link(__(('playlists'), true), array('controller'=> 'pages', 'action'=>'playlists'), array('escape' => false, 'class'=>'d-menu')); ?></li>
				...
				<?php
					...
					echo '<a href="'.$json['creator']['tracklist'].'" target="_blank" class="created"><strong>by</strong> '.$json['creator']['name'].'</a>';
						...
						<tbody>
							<?php
								...
								foreach($json['tracks']['data'] as $key => $track):
									...
									echo '<td><a href="javascript:void(0);" onclick="DZ.player.playTracks(['.$comma_separated_ids.'], '.$key.'); return false;" href="#play-'.$track['id'].'">'.$track['album']['title'].'</a></td>';
