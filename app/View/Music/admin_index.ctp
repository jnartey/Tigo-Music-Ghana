	...
	<div class="row">
		...
		<div class="large-10 columns content">
			...
			<?php //echo $this->Html->link(__(("+ Add"), true), array('controller'=> 'music', 'action'=>'add', 'admin' => true), array('escape' => false, 'class'=>'button small secondary')); ?><br />
			<table  cellspacing="0">
			    <thead>
			<tr>
			...
			?>
				<tr>
					<td>
						<?php 
							$Count = AppController::countRows('Music', 'category', $item['Music']['id']);
							$pageCount = $Count;
							echo '<span class="count">'.$pageCount.'</span> '.$item['Music']['name']; 
						?>
					</td>
					<td class="actions">
						<?php echo $this->Html->link(__("View", true), array('controller'=> 'music', 'action'=>'view', $item['Music']['id'], 'admin' => true), array('escape'=>false, 'class'=>'button tiny primary')); ?>
						<?php echo $this->Html->link(__("Edit", true), array('controller'=> 'music', 'action'=>'edit', $item['Music']['id'], 'admin' => true), array('escape'=>false, 'class'=>'button tiny secondary')); ?>
