...
class AcosController extends AclAppController {
	...
	function admin_empty_acos($run = null)
	{
		...
		$header = "Advanced User Settings";
		$current_page = "User Actions :: Clear actions ACOs";
		$this->set(compact('header', 'current_page'));
	}
	...
	function admin_build_acl($run = null)
	{
		...
		$header = "Advanced User Settings";
		$current_page = "User Actions :: Build actions ACOs";
		$this->set(compact('header', 'current_page'));
	}
    ...
    function admin_prune_acos($run = null)
    {
		...
		$header = "Advanced User Settings";
		$current_page = "User Actions :: Prune actions ACOs";
		$this->set(compact('header', 'current_page'));
    }
    ...
    function admin_synchronize($run = null)
    {
		...
		$header = "Advanced User Settings";
		$current_page = "User Actions :: Synchronize actions ACOs";
		$this->set(compact('header', 'current_page'));
    }
}
?>