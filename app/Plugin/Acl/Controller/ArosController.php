...
class ArosController extends AclAppController
{
	...
	function admin_check($run = null)
	{
		...
		$header = "Advanced User Settings";
		$current_page = "User Permissions :: Build missing AROs";
		$this->set(compact('header', 'current_page'));
	...
	function admin_users()
	{
		...
		$header = "Advanced User Settings";
		$current_page = "User Permissions :: Users roles";
		$this->set(compact('header', 'current_page'));
	}
	...
	function admin_ajax_role_permissions()
	{
		...
		$header = "Advanced User Settings";
		$current_page = "User Permissions :: Role permissions";
		$this->set(compact('header', 'current_page'));
	}
	...
	function admin_user_permissions($user_id = null)
	{
	    ...
	    else
	    {
            ...
            else
            {
		    	...
		    	if($count != 0)
		    	{
					...
					$header = "Advanced User Settings";
					$current_page = "User Permissions :: Manage user specific rights";
					$this->set(compact('header', 'current_page'));
		    	}
		    	else
		    	{
		...
		$header = "Advanced User Settings";
		$current_page = "User Permissions :: Users permissions";
		$this->set(compact('header', 'current_page'));
	}
