...
<div class="row">
	...
	<div class="large-9 columns content">
		...
		<div class="large-12 columns">
			<table border="0" cellpadding="5" cellspacing="2">
				...
				<tr>
					<td class="paging" colspan="<?php echo $column_count ?>">
						<?php echo $this->Paginator->prev('<< ' . __d('acl', 'previous'), array(), null, array('class'=>'disabled'));?>| <?php echo $this->Paginator->numbers(array('modulus' => 5, 'first' => 2, 'last' => 2, 'after' => ' ', 'before' => ' '));?> | <?php echo $this->Paginator->next(__d('acl', 'next') . ' >>', array(), null, array('class' => 'disabled'));?>
					</td>
				</tr>
			</table><?php
			}
			...
			?>
			<h1>
				<?php echo  __d('acl', $user_model_name) . ' : ' . $user[$user_model_name][$user_display_field]; ?>
			</h1>
			<h2>
				<?php echo __d('acl', 'Role'); ?>
			</h2>
			<table border="0">
				<tr>
					<?php
