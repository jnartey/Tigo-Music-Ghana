 ...
 */
	...
	public function index(){
		...
		$news = $this->News->find('all', array('order' => array('News.timestamp' => 'DESC'), 'limit' => 10));
		$news_highlights = $this->News->find('all', array('conditions' => array('News.publish_home'=>1), 'order' => array('News.timestamp'=>'DESC'), 'limit' => 3));
		
		$this->set(compact('title_for_layout', 'main_page_title', 'banners', 'playlists', 'news', 'upcoming_artists', 'events', 'pre_releases', 'videos', 'page_meta_description', 'page_meta_keywords', 'news_highlights', 'events_highlights'));
	}
	...
	public function news($id=null){
		...
		$this->paginate = array('conditions'=>array('News.publish'=>1), 'order'=>array('News.timestamp' => 'DESC'), 'limit' => 20);
	...
	public function events($id=null){
		...
		$this->set(compact('title_for_layout', 'main_page_title', 'banners', 'events', 'event_data', 'page_meta_description', 'page_meta_keywords'));
	}
